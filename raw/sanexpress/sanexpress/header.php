	        	...
	        	<div class="st-content">
					  					...
					  					<div class="col-sm-6 col-xs-12">
						  					<div class="call-to-action">
						  						<ul class="list-inline">
						  							<li><a href="#"><i class="fa fa-phone"></i> +880-248-955-066</a></li>
						  							<li><a href="#"><i class="fa fa-envelope"></i>sancourier.shahin@gmail.com</a></li>
						  						<li><a href="#"><i class="fa fa-envelope"></i>sancourier.roman@gmail.com</a></li>
												</ul>
						  					</div><!-- /.call-to-action -->
					  					</div><!-- /.col-sm-6 -->
							...
							<div class="container mainnav">
								...
								<div class="collapse navbar-collapse navbar-collapse">
									...
									<ul class="nav navbar-nav navbar-right">
										<!-- Home --><li><div id="loaderImage"></div></li>
										<li>	<img src="img/SAN_EXPRESS_logo.gif" alt=""></li>
                                        <li class="dropdown active"><a href="index.php">Home</a></li>
                                        <!-- /Home -->
									
											<li><a href="index.php?page=about_company">About Company</a></li>
											<li><a href="index.php?page=our_service">Our Service</a></li>
                            ...
                            <div class="item active">
                                ...
                                <div class="container">
                                    <div class="carousel-caption">
                                        ...
                                        <div class="phone animated lightSpeedIn">+880-1674-068-958/+880-1755-991-533</div>
                                          <h1 class="animated bounceIn">SAN EXPRESS</h1><BR/>
                    ...
                    <!-- #main-carousel-->
						...
						this.value='';" onblur="if (this.value=='') this.value=this.defaultValue;" class="form-control"  required="" placeholder="Enter way bill no" autofocus>
										  ...
										  <form name="the_form" id="frmlogin" method="post" action="index.php">
											<div class="col-md-2">
