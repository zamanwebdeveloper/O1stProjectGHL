...
<!--
  ...
  location.href="about.php?h="+myHeight;
-->
</script>
...
<h3 style="text-align:left; font:arial; color:#EE0000; margin-left:10px; padding-top:15px">Our Vision</h3>
	<p style="font-family:tahoma; text-align:justify; font-size:16px; margin:5px 30px 5px 30px ">The long range vision of OMEX is to become one of the APIC Company in the regional Express Industry. We aim to develop a seamless quality of service & standard across the country. 
We provide a comfortable operation procedure, affordable rates, service driven, modernized facilities to ensure customer’s satisfaction at all levels.
</p>
	
<h3 style="text-align:left; font:arial; color:#EE0000; padding-top:15px; margin-left:10px; padding-bottom:5px">Our Team</h3>			
					
	<p style="font-family:tahoma; text-align:justify; font-size:16px;  margin:5px 30px 5px 30px;"> All our offices across the country are staffed by highly dedicated, strongly committed and well trained professionals to ensure the best possible attention to ops & customer service in our premises.
	</p>
					  	</td>			
