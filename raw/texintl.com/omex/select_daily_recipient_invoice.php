...
<form id="monthrepo" name="monthrepo" method="post" action="report_recivier_info_out.php" onsubmit='return formValidator()'>
  ...
  <table width="100%" border="0" bgcolor="#E6E6E6">
    <tr>
      <td height="355" valign="top"><table width="76%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#F7F7F7" bgcolor="#F0F0F0">
          <tr> 
            <td width="29%" rowspan="4" valign="top"><script type="text/javascript" language="JavaScript1.2">
<!--
...
appendSTMI("false","Individualy&nbsp;Agent&nbsp;Invoice&nbsp;Report","left","middle","","","-1","-1","0","normal","#990000","#990000","","0","-1","-1","blank.gif","blank.gif","4","4","1","","select_indivi_agen_invoice.php","_self","Arial","9pt","#cccccc","bold","normal","none","Arial","9pt","#ffffff","bold","normal","none","3","solid","#cc0000","#822000","#610000","#bf0000","#822000","#cc0000","#bf0000","#610000","select_indivi_agen_invoice.php","","","tiled","tiled");
appendSTMI("false","Agent&nbsp;List","left","middle","","","-1","-1","0","normal","#990000","#990000","","0","-1","-1","blank.gif","blank.gif","4","4","1","","report_agent_info_out.php","_self","Arial","9pt","#cccccc","bold","normal","none","Arial","9pt","#ffffff","bold","normal","none","3","solid","#cc0000","#822000","#610000","#bf0000","#822000","#cc0000","#bf0000","#610000","report_agent_info_out.php","","","tiled","tiled");
endSTMB();
endSTMB();
endSTM();
//-->
            ...
            <td height="34" colspan="3" valign="top" background="item/Footer.gif"><div align="center"><font color="#330099" size="-1" face="Courier New, Courier, mono">Search 
                Daily Recipient Sheet</font></div></td>
          </tr>
          <tr> 
