...
<body>
<form id="monthrepo" name="monthrepo" method="post" action="report_seper_agen_invoice_out_dom.php" onsubmit='return formValidator()' target="_blank">
   <table width="76%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#F7F7F7" bgcolor="#F0F0F0">
          ...
          <tr>
            <td height="36" valign="top"> &nbsp; Agent_id</td>
            <td valign="top">:</td>
            <td valign="top"><input name="agent_id" type="text" id="agent_id"></td>
          </tr>
          <tr> 
