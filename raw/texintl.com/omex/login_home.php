...
?>
<frameset rows="60,*,17" frameborder="1" border="0" framespacing="0">
  <frame src="login_head.html" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" />
  <frame src="login_view.php<?php echo $get_var;?>" name="mainFrame" scrolling="No" noresize="noresize" id="mainFrame" />
