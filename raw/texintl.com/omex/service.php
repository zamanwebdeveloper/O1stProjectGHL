			...
			<div id="write">
				...
				<table border="0"  bordercolor="#FF9900" height="100%" width="732" style="font-family:arial; font-size:15px" >
					<tr>
						...
						<td rowspan="3">
						<h1 style="margin-left:10px; padding-bottom:10px">Service</h1>
							
						<table border="0" width="100%" cellpadding="1">
							<tr>
								<td> <img src="images/bullet.gif" height="14" width="14" /></td>
								<td colspan="2"> <b>International Express delivery service</b>.<br/></td>
							</tr>	
								
							<tr>
								<td>&nbsp;</td>
								<td>1.</td>
								<td> VIA - DHL, Fedex, TNT, Aramex, TCS for Eerope, USA, UK, CANADA, form Dubai.</td>
							</tr>	
				
							<tr>
							<td>&nbsp;</td>
								<td>2</td>
								<td>VIA - DPEX, Fardar, SCS express, Firstflight, For Asia form Hong kong.</td>
							</tr>	
							
							<tr>
								<td>&nbsp;</td>
								<td>3</td>
								<td> VIA - Firstflight, Bluedart, DTDC for Indian subcontinant. </td>
							</tr>
							...
							<tr>
								...
								<td> <img src="images/bullet.gif" height="14" width="14" /></td>
								<td colspan="2"> <b>International Cargo service</b>.<br/></td>
							</tr>
							
							<tr>
							<td>&nbsp;</td>
								<td>1.</td>
								<td> VIA - DHL, Aramex, Saudia Airlines, Royal Asia, Dragon Air</td>
							</tr>	
							...
							<tr>
								<td> <img src="images/bullet.gif" height="14" width="14" /></td>
								<td colspan="2"> <b>Clearing & Forwarding , Import service </b>.<br/></td>
							</tr>	
							
							<tr>
								<td>&nbsp;</td>
								<td>1</td>
								<td> All kinds of works from custom-Land, Sea & Air. </td>
							</tr>	
							
							<tr>
								<td>&nbsp;</td>
								<td>2</td>
								<td> All kinds of forwarding documentation works with cargo service. </td>
							</tr>
							
							<tr>
								<td>&nbsp;</td>
								<td>3</td>
								<td> All kinds of imported items processing form Chaina, Hong kong, India, Koriea, Malaysia and others. </td>
							</tr>	
							...
							<tr>
								<td> <img src="images/bullet.gif" height="14" width="14" /></td>
								<td colspan="2"> <b>Domestic service </b>.<br/></td>
							</tr>	
							
							<tr>
								<td>&nbsp;</td>
								<td colspan="2"> * Premier Service, * Special Service, * Secured Service, * General Service </td>
							</tr>
