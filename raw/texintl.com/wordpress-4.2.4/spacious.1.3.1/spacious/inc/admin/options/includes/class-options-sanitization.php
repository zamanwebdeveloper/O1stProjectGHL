...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'spacious' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'spacious' ),
		'repeat-y'  => __( 'Repeat Vertically', 'spacious' ),
		'repeat'    => __( 'Repeat All', 'spacious' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'spacious' ),
		'top center'    => __( 'Top Center', 'spacious' ),
		'top right'     => __( 'Top Right', 'spacious' ),
		'center left'   => __( 'Middle Left', 'spacious' ),
		'center center' => __( 'Middle Center', 'spacious' ),
		'center right'  => __( 'Middle Right', 'spacious' ),
		'bottom left'   => __( 'Bottom Left', 'spacious' ),
		'bottom center' => __( 'Bottom Center', 'spacious' ),
		'bottom right'  => __( 'Bottom Right', 'spacious')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'spacious' ),
		'fixed'  => __( 'Fixed in Place', 'spacious')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'spacious' ),
		'italic'      => __( 'Italic', 'spacious' ),
		'bold'        => __( 'Bold', 'spacious' ),
		'bold italic' => __( 'Bold Italic', 'spacious' )
		);
