...
<form name="display" action="login_view.php?page=inertinfo.php" method="post" target="mainFrame">
  <tr> 
  ...
  <form name="display" action="login_view.php?page=edittrack.php" method="post" target="mainFrame">
  <tr> 
...
<tr align="left" bgcolor="#6600FF">
    <th width="20%" style="color: #FFFFFF" >Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Time</th>
<th width="21%" style="color: #FFFFFF" >HAWB</th>
<th width="38%" style="color: #FFFFFF" >Location</th>
<th width="22%" style="color: #FFFFFF" >Action</th>
</tr>
<base target="mainFrame">
  <?php
	...
	$targetpage = "login_view.php?page=admin.php"; 	//your file name  (the name of this file)
...
?>
	...
	?>
		<tr <?php echo $bgcolor;?>>
			...
			<td><a href="login_view.php?page=edittrack.php&option=edit&ref=<?php echo $row['HAWB']?>" class="news">Add Tracking Info</a> | <a href="login_view.php?page=inertinfo.php&option=edit&ref=<?php echo $row['HAWB'];?>">Edit Info</a></td>
  </tr>
